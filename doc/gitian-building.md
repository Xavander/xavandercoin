...
git clone https://github.com/xavander-crypto/xavander.git
cd xavander
...
```bash
    ...
    From https://github.com/xavander-crypto/xavander
...
For example:
```bash
URL=https://github.com/crowning-/xavander.git
...
[xavander/gitian.sigs](https://github.com/xavander-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
