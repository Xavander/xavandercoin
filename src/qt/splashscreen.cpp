...
QString copyrightTextXav = QChar(0xA9) + QString(tr(" 2018 The Xavander Core developers"));
...
pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextXav);
