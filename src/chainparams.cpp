...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0xdd7de7f65b1776aeadaafc8e754af1cfc1218045bdf708c4d53b9c8407dc7585"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1534587821, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
       ...
       // nMasternodeCollateralLimit = 10000; //Old code from orginal codebase
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1534587821;
        genesis.nBits = 0x504365040;
        genesis.nNonce = 1412698;
...
//		printf("genesis.hashMerkleRoot = %s\n", genesis.hashMerkleRoot.ToString().c_str());
		...
		//DNS Seeds
		vSeeds.push_back(CDNSSeedData("149.28.56.206", "2149.28.56.206"));
		vSeeds.push_back(CDNSSeedData("149.28.230.40", "149.28.230.40"));
		vSeeds.push_back(CDNSSeedData("139.99.194.165", "139.99.194.165"));
        ...
        strSporkKey = "037a724415fd855cf2e2a4b18dd1853dd837e8d84860108345bb06a34ce3bcf050";
